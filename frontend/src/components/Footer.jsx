...
const Footer = () => {
  ...
  <div class="container" >
    <div class="container-fluid bg-light" style={{borderRadius:"1rem"}}>
      <div class="row justify-content-center" id="footer-details">
            ...
            <div class="container-fluid overflow-hidden">
              <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                  <div class="widget">
                    <a href="#!">
                      <p id="footer-brand" className="navbar-brand" ></p>
                      <img src={logo} alt="EcoFlo LOGO" id='footer-img'></img>
                    </a>
                  </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                  <div class="widget">
                    <h4 class="widget-title mb-4" className="footer-heading">Services</h4>
                ...
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                  <div class="widget">
                    <h4 class="widget-title mb-4" className="footer-heading">Company</h4>
                    <ul class="list-unstyled">
                      <li class="mb-2">
                ...
                <div class="col-12 col-lg-3 col-xl-4">
                  <div class="widget">
                    <h4 class="widget-title mb-4" className="footer-heading">Our Newsletter</h4>
                      ...
                      <div class="row gy-4">
                        <div class="col-12">
                          <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="email-newsletter" value="" placeholder="Email Address" aria-label="email-newsletter" aria-describedby="email-newsletter-addon" required></input>
                          </div>
                        </div>
                        <div class="col-12">
                          <div class="d-grid">
          ...
          <div class="py-4 py-md-5 py-xl-8 border-top border-light-subtle">
            <div class="container-fluid overflow-hidden">
              <div class="row gy-4 gy-md-0">
                <div class="col-xs-12 col-md-7 order-1 order-md-0" style={{width:'300px',fontSize:"1.25rem"}}>
                  <div class="copyright text-center text-md-start">
                    &copy; 2024. All Rights Reserved.
                  </div>
                  <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
                    Built by <a href="https://www.linkedin.com/in/yashmehta11k/" class="link-secondary text-decoration-none">Yash P Mehta</a> with <span class="text-primary">&#9829;</span>
                  </div>
                </div>

                <div class="col-xs-12 col-md-5 order-0 order-md-1" style={{width:"50%"}}>
                  <ul class="nav justify-content-center justify-content-md-end" >
                    ...
                    <li class="nav-item">
                      <a class="nav-link link-dark" href="#!">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="bi bi-youtube" viewBox="0 0 16 16">
